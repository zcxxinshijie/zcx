<template>
  <div class="view-layout">
    <!-- 画图示例 -->
      ...
      <div class="view2">
          <div style="display:flex;flex-direction:column;justify-content: space-between;height:calc((100vh - 68px) * 0.51);">
              <p class="wenzi">新视锐全国分布</p>
              <div id="test5" style="margin: auto;width: 78%;height: 80%;"></div>
          </div>
          <div id="dongtai">
          ...
          <div style="height:calc((100vh - 68px) * 0.20);margin-bottom:calc((100vh - 68px) * 0.03);">
              <p class="wenzi">总览</p>
              <a-row style="margin:calc((100vh - 68px) * 0.025 + 15px) 35px 10px">
                  <a-col span="12" style="display: flex;justify-content: flex-start;">
                      <img src="../../assets/用户.png" alt="Big Boat" width="50" height="45" style="margin: 15px 10px 0 0">
                      <a-statistic title="累计注册用户" :value="1128">
                      </a-statistic>
                  </a-col>
                  <a-col span="12" style="display: flex;justify-content: flex-start;">
                      <img src="../../assets/图表-02.png" alt="Big Boat" width="50" height="45" style="margin: 15px 10px 0 0">
                      <a-statistic title="累计注册视光师" :value="1228">
                      </a-statistic>
                  </a-col>
              </a-row>
              <a-row style="margin: 10px 35px 0 35px">
                  <a-col span="12" style="display: flex;justify-content: flex-start;">
                      <img src="../../assets/图表-01.png" alt="Big Boat" width="50" height="45" style="margin: 15px 10px 0 0">
                      <a-statistic title="累计注册渠道" :value="1128">
                      </a-statistic>
                  </a-col>
                  <a-col span="12" style="display: flex;justify-content: flex-start;">
                      <img src="../../assets/图表-03.png" alt="Big Boat" width="50" height="45" style="margin: 15px 10px 0 0">
                      <a-statistic title="累计注册门店" :value="1228">
                      </a-statistic>
                  </a-col>
              </a-row>
          </div>
...
/*#test5{*/
/*    width:calc((100vw - 200px) * 0.32);*/
/*    height:calc((100vh - 68px) * 0.35);*/
/*}*/
#dongtai{
    height:calc((100vh - 68px) * 0.20);
}
#example{
    display: flex;
    align-items: center;
    width:calc((100vw - 200px) * 0.25);
    height:calc((100vh - 68px) * 0.4);
    margin: 0 auto;
}
#goodsForm{
    /*width:384px;*/
