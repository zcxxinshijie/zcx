    ...
    <!-- 画图示例 -->
      ...
      <div class="view2">
          <div style="display:flex;flex-direction:column;">
              ...
              <div id="test5" style="margin:0 auto;"></div>
          </div>
          <div id="dongtai">
              <p class="wenzi">实时动态</p>
              <ul style="margin-top:calc((100vh - 68px) * 0.03);">
                  <li>用户在<span style="color: #0f19ff">视力康复中心</span>进行了训练</li>
                  <li>用户在视力康复中心进行了训练</li>
                  <li>用户在视力康复中心进行了训练</li>
              </ul>
          </div>
          <div style="margin-bottom:calc((100vh - 68px) * 0.03);">
              <p class="wenzi">总览</p>
